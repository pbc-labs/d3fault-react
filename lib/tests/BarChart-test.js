...
describe('BarChartLeft component', function () {
  ...
  beforeEach(function () {
    _this2.renderer = _reactAddonsTestUtils2.default.createRenderer();
    _this2.renderer.render(_react2.default.createElement(_barChartLeft2.default, null), context);
    _this2.result = _this2.renderer.getRenderOutput();
    _this2.tree = _skinDeep2.default.shallowRender($(_barChartLeft2.default));
    _this2.vdom = _this2.tree.getRenderOutput();
    _this2.mounted = _this2.tree.getMountedInstance();
  });

  it("renders the BarChart into a div", function () {
    (0, _chai.expect)(_this2.vdom).to.have.property('type', 'div');
  });

  it("renders the BarChart with width prop set to default width", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('width');
    (0, _chai.expect)(_this2.vdom.props.children.props.width).to.equal(600);
  });

  it("mounts the BarChart with width prop set to default width", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('width');
    (0, _chai.expect)(_this2.mounted.props.width).to.equal(600);
  });

  it("renders the BarChart with height prop set to default height", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('height');
    (0, _chai.expect)(_this2.vdom.props.children.props.height).to.equal(400);
  });

  it("mounts the BarChart with height prop set to default height", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('height');
    (0, _chai.expect)(_this2.mounted.props.height).to.equal(400);
  });

  it("renders the BarChart with title prop set to default title", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('title');
    (0, _chai.expect)(_this2.vdom.props.children.props.title).to.equal('Default Title');
  });

  it("mounts the BarChart with title prop set to default title", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('title');
    (0, _chai.expect)(_this2.mounted.props.title).to.equal('Default Title');
  });

  it("renders the BarChart with margins prop set to default margins", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('margins');
    (0, _chai.expect)(_this2.vdom.props.children.props.margins.top).to.equal(30);(0, _chai.expect)(_this2.vdom.props.children.props.margins.bottom).to.equal(50);
    (0, _chai.expect)(_this2.vdom.props.children.props.margins.left).to.equal(55);
    (0, _chai.expect)(_this2.vdom.props.children.props.margins.right).to.equal(30);
  });

  it("mounts the BarChart with margins prop set to default margins", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('margins');
    (0, _chai.expect)(_this2.mounted.props.margins.top).to.equal(30);
    (0, _chai.expect)(_this2.mounted.props.margins.bottom).to.equal(50);
    (0, _chai.expect)(_this2.mounted.props.margins.left).to.equal(55);
    (0, _chai.expect)(_this2.mounted.props.margins.right).to.equal(30);
  });

  it("renders the BarChart with fontSize prop set to default fontSize", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('fontSize');
    (0, _chai.expect)(_this2.vdom.props.children.props.fontSize).to.equal(14);
  });

  it("mounts the BarChart with fontSize prop set to default fontSize", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('fontSize');
    (0, _chai.expect)(_this2.mounted.props.fontSize).to.equal(14);
  });

  it("renders the BarChart with fontStyle prop set to default fontStyle", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('fontStyle');
    (0, _chai.expect)(_this2.vdom.props.children.props.fontStyle).to.equal('Sans Serif');
  });

  it("mounts the BarChart with fontStyle prop set to default fontStyle", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('fontStyle');
    (0, _chai.expect)(_this2.mounted.props.fontStyle).to.equal('Sans Serif');
  });

  it("renders the BarChart with titleFontSize prop set to default titleFontSize", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('titleFontSize');
    (0, _chai.expect)(_this2.vdom.props.children.props.titleFontSize).to.equal(18);
  });

  it("mounts the BarChart with titleFontSize prop set to default titleFontSize", function () {
    (0, _chai.expect)(_this2.mounted.props).to.have.property('titleFontSize');
    (0, _chai.expect)(_this2.mounted.props.titleFontSize).to.equal(18);
  });

  it("renders the BarChart with mainClassName prop set to 'd3fault-chart'", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('mainClassName');
    (0, _chai.expect)(_this2.vdom.props.children.props.mainClassName).to.equal('d3fault-chart');
  });

  it("renders the BarChart with titleClassName prop set to 'd3fault-title'", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('titleClassName');
    (0, _chai.expect)(_this2.vdom.props.children.props.titleClassName).to.equal('d3fault-title');
  });

  it("renders the BarChart with svgClassName prop set to 'd3fault-svg'", function () {
    (0, _chai.expect)(_this2.vdom.props.children.props).to.have.property('svgClassName');
    (0, _chai.expect)(_this2.vdom.props.children.props.svgClassName).to.equal('d3fault-svg');
  });
});
