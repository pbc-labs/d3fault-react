...
describe('Chart component', function () {
  ...
  it("BarChart renders into a div", function () {
    ...
    renderer.render(_react2.default.createElement(_barChart2.default, null), context);
    var result = renderer.getRenderOutput();

    (0, _chai.expect)(result.type).to.equal('div');
  });
  ...
  it("renders proper width prop (not using ShollowTestUtls)", function () {
    var renderer = _reactAddonsTestUtils2.default.createRenderer();
    renderer.render(_react2.default.createElement(_barChart2.default, null), context);
    console.log(renderer.getRenderOutput().props.children);
    (0, _chai.expect)(renderer.getRenderOutput().props.children.props.width).to.equal(600);
  });

  it("renders proper width prop", function () {
    var renderer = _reactAddonsTestUtils2.default.createRenderer();
    renderer.render(_react2.default.createElement(_barChart2.default, null), context);
    var barChart = _reactShallowTestutils2.default.getMountedInstance(renderer);
